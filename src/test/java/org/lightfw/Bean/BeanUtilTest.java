package org.lightfw.Bean;

import junit.framework.TestCase;
import org.junit.Test;
import org.lightfw.util.ext.bean.BeanUtil;
import org.lightfw.util.ext.bean.PropertyFilter;
...
public class BeanUtilTest extends TestCase {
    ...
    public void testHasProperties() {
        ...
        TestCase.assertEquals(true, BeanUtil.hasProperty(bean, "operationName"));
        ...
        assertEquals(true, BeanUtil.hasPropertyFilter(bean, "operationType", new PropertyFilter() {
            ...
            public String Properties(String pro) {
                //忽略属性字段中"_" 并安装小写比较
                return StringExtUtil.remove(pro, "_").toLowerCase();
            }
        }));
    ...
    public void testCopyProperties() throws InvocationTargetException, IllegalAccessException {
        ...
        BeanUtil.copyProperties(bean1, bean2, new PropertyFilter() {
            @Override
            public String Properties(String pro) {
                return StringExtUtil.remove(pro, "_").toLowerCase().replaceAll("yy", "ty");
            }
        });

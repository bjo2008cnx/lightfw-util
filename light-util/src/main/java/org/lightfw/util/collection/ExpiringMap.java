...
public class ExpiringMap<K, V> implements Map<K, V> {
    ...
    private final ConcurrentHashMap<K, ExpiringObject> delegateMap;
    ...
    private ExpiringMap(ConcurrentHashMap<K, ExpiringObject> delegateMap, CopyOnWriteArrayList<ExpirationListener<V>> expirationListeners, int timeToLive,
    ...
    public V put(K key, V value) {
        ExpiringObject answer = delegateMap.put(key, new ExpiringObject(key, value, System.currentTimeMillis()));
        if (answer == null) {
            return null;
        }
    ...
    public V get(Object key) {
        ExpiringObject object = delegateMap.get(key);
        if (object != null) {
    ...
    public V remove(Object key) {
        ExpiringObject answer = delegateMap.remove(key);
        if (answer == null) {
            return null;
        }
        return answer.getValue();
    ...
    public class Expirer implements Runnable {
        ...
        private void processExpires() {
            ...
            for (ExpiringObject o : delegateMap.values()) {
         ...
         * 设置时间间隔
         *
         * @param expirationInterval 时间间隔(秒)
         */

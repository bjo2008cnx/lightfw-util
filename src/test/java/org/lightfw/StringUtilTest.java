...
public class StringUtilTest {
    ...
    public void testformatDouble() {
        ...
        assertEquals("10.01", StringExtUtil.formatDouble(d, "##.00"));
        assertEquals("10.0120", StringExtUtil.formatDouble(d, "##.0000"));
    }
    ...
    public void testRequals() throws Exception {
        assertEquals(true, StringExtUtil.requals("1", "1	,5,7,9,10,13,14"));
        assertEquals(true, StringExtUtil.requals("7", "1,5, 7 ,9,10,13,14"));
        assertEquals(true, StringExtUtil.requals("9", "1,5,7,9,10,13,14"));
        assertEquals(false, StringExtUtil.requals("15", "1,5,7,9,10,13,14"));
        assertEquals(true, StringExtUtil.requals("15", "15|7|9|10|13|14", "\\|"));
    }
    ...
    public void testgetHideEmailPrefix() {
        ...
        System.out.println(StringExtUtil.getHideEmailPrefix(str1));
    }
    ...
    public void testtrimPunct() {
        ...
        System.out.println(StringExtUtil.trimPunct(str1));
    }
    ...
    public void testStringSimilar() {
        ...
        String en2 = "$ Summary\n" +
                ...
                "* [Chapter20](chapter20/README)\n" +
                "* [Chapter20](chapter20/README)\n";
        System.out.println(StringExtUtil.similarDegree(en1, en2));
        //中文测试
        String input1 = "每样东西都有根本有枝末，每件事情都有开始有终结。明白了这本末始终的道理，就接近事物发展的规律了。";
        String input2 = "物品有基础也有末路，事情有开始也有终结。知道先与后，就近乎得道了。";
        System.out.println(StringExtUtil.similarDegree(input1, input2));
        System.out.println(StringExtUtil.similarityRatio(input1, input2));
        String input3 = "鬼谷子是春秋战国时期道家、纵横家的鼻祖.";
        String input4 = "鬼谷子是春秋战国著名的思想家、道家、谋略家，称得上是先秦最神秘的历史人物";
        System.out.println(StringExtUtil.similarDegree(input3, input4));
        System.out.println(StringExtUtil.similarityRatio(input3, input4));
    ...
    public void testcountSubStr() {
        ...
        assertEquals(4, StringExtUtil.countSubStr(str, "鬼谷子"));
    }
    ...
    public void testReplaceFirst() {
        ...
        assertEquals("12345", StringExtUtil.remove(str1, ","));
    }

    @Test
    public void testIsIn() {
        String[] str1 = new String[]{"method1", "method2", "method3", "method4"};
        assertEquals(true, StringUtil.in("method3", str1));
    }
    ...
    public void testRigthEquals() throws Exception {
        ...
        assertEquals(true, StringExtUtil.rigthEquals("utils/StringUtil.java", "utils/StringUtil.java", 5));

    }

    @Test
    public void testLeftEquals() throws Exception {
        assertEquals(true, StringExtUtil.leftEquals("utils/StringUtil", "utils/EmailUitl", 6));
    }
}
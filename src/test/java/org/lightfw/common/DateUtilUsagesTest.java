...
public class DateUtilUsagesTest {
    ...
    public void testList() {
        ...
        List<String> lines = FileExtUtil.lines(file);
    ...
    public void testListLine() throws ParseException {
        ...
        for (String line : lines) {
            String[] tt = line.split("/");
            count += DateUtil2.subtimeBurst(tt[0], tt[1], "08:00-19:30");
            count1 += DateUtil2.subtract(tt[0], tt[1]);
        }
        ...
        for (String line : lines) {
            ...
            if (group.get(tt[2]) != null) {
                ...
                if (value != null && !"".equals(value)) {
                    ...
                    sum += (int) DateUtil2.subtimeBurst(tt[0], tt[1], "08:00-19:30");
                    count = Integer.parseInt(ss[1]) + 1;
                }
                group.put(tt[2], sum + ":" + count);
            } else {
                int sum = (int) DateUtil2.subtimeBurst(tt[0], tt[1], "08:00-19:30");
                int count = 1;
                group.put(tt[2], sum + ":" + count);
            }
        }
